...
def _carry_forward_previous(c, sport, previous, current_features):
    ...
    if not (feature_version.startswith("strict-pit-v13-") or feature_version.startswith("strict-pit-v14-") or feature_version.startswith("strict-pit-v15-") or feature_version.startswith("strict-pit-v16-") or feature_version.startswith("strict-pit-v17-") or feature_version.startswith("strict-pit-v18-")):
        return None
