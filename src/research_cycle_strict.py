...
def train(s):
 ...
 try:
  ...
  # Always materialize holdout component predictions for downstream research layers.
  # Single-model incumbents have no routing surface, but the case-risk layer still
  # needs the incumbent's frozen-holdout probability without touching production.
