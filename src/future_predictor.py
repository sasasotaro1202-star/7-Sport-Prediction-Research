...
def main():
    ...
    # Keep eligibility derived from the same exact inference pass.
    # This prevents the stale eligibility artifact seen in earlier runs.
    eligibility=[]
    for item in results:
    ...
    ELIGIBILITY_OUT.write_text(json.dumps(eligibility_report,ensure_ascii=False,indent=2),encoding='utf-8')
