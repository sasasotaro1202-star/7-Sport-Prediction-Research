        ...
        for e in events:
            ...
            for p in ps:
                ...
                for stat in POLICY[sport]:
                    vals=c.execute("""SELECT ms.stat_id,ms.event_id,ms.value_num,ms.effective_at_utc,ss.snapshot_id
                                     FROM match_stats ms
                                    ...
                                    (sport,pid,stat,et,eid,cutoff,cutoff)).fetchall()
