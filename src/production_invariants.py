...
def main():
    ...
    try:
        ...
        require(
            'router.fit_final_router_from_folds(X,y,router_names,oof_folds,sel' in strict_src,
            'strict research cycle must fit final router from computed chronological OOS folds'
        )
        base_src=(ROOT/'src/research_cycle_v4.py').read_text(encoding='utf-8')
